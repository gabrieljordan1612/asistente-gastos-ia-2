            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    <div className="flex-shrink-0">
                        <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-2xl font-bold text-text-primary">FinTrack</a>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <button onClick={onNavigateToSignUp} className="bg-secondary text-white font-bold py-2 px-4 rounded-lg hover:bg-green-600 transition-transform duration-300 hover:scale-105 shadow-lg shadow-secondary/20">
                            Registrarse
                        </button>
                    </div>
                </div>
...
const HeroSection: React.FC<{ onNavigateToSignUp: () => void; }> = ({ onNavigateToSignUp }) => (
    <section className="relative py-20 sm:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-bkg -z-10" />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedComponent delay={100}>
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-text-primary tracking-tighter leading-tight">
                    Tus finanzas, <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-green-500">claras y automáticas.</span>
                </h1>
            </AnimatedComponent>
            ...
            <AnimatedComponent delay={500}>
                <div className="mt-8">
                    <button onClick={onNavigateToSignUp} className="bg-secondary text-white font-bold py-3 px-8 rounded-lg hover:bg-green-600 transition-transform duration-300 hover:scale-105 text-lg shadow-xl shadow-secondary/20">
                        Empieza Gratis
                    </button>
                </div>
            </AnimatedComponent>
        ...
        <AnimatedComponent delay={700} className="mt-16">
            <div className="relative w-full max-w-4xl mx-auto p-4">
                 <div className="relative bg-surface rounded-xl shadow-xl border border-border p-4">
                    <div className="flex items-center justify-between pb-2 border-b border-border">
                       ...
                       <div className="bg-bkg rounded-md text-xs px-4 py-1 text-text-secondary">fintrack/dashboard</div>
                    </div>
                    <div className="mt-4">
                         <div className="flex space-x-4">
                             <div className="w-2/3">
                                 <div className="font-bold text-text-primary">Análisis Gráfico</div>
                                 <div className="mt-2 h-40 bg-bkg rounded-lg flex items-end p-2 space-x-2">
                             ...
                             <div className="w-1/3">
                                ...
                                <div className="mt-2 space-y-2">
                                    <div className="h-10 bg-bkg rounded-lg animate-pulse" style={{animationDelay: '0.6s'}}></div>
                                    <div className="h-10 bg-bkg rounded-lg animate-pulse" style={{animationDelay: '0.7s'}}></div>
                                    <div className="h-10 bg-bkg rounded-lg animate-pulse" style={{animationDelay: '0.8s'}}></div>
                                </div>
                             </div>
                         </div>
                    </div>
...
const features = [
    {
        ...
        visual: (
            <div className="bg-bkg rounded-xl p-4 border border-border w-full h-full flex items-center justify-center">
                <div className="flex items-center space-x-4">
                    <div className="w-40 h-60 bg-surface rounded-lg overflow-hidden shadow-md flex-shrink-0 border border-border">
                         <div className="p-2 bg-surface h-full">
                            <div className="h-4 bg-bkg rounded w-3/4"></div>
                            <div className="mt-4 space-y-1">
                                <div className="h-2 bg-bkg rounded w-full"></div>
                                <div className="h-2 bg-bkg rounded w-5/6"></div>
                                <div className="h-2 bg-bkg rounded w-full"></div>
                            </div>
                            <div className="mt-4 h-3 bg-bkg rounded w-1/2"></div>
                             <div className="mt-6 border-t border-dashed border-border pt-4 space-y-2">
                                <div className="h-2 bg-bkg rounded w-full"></div>
                                <div className="h-2 bg-bkg rounded w-2/3"></div>
                             </div>
                              <div className="mt-4 font-black text-text-primary text-lg text-right">S/. 25.50</div>
                         </div>
                    </div>
                     <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-secondary animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                    <div className="w-48 bg-surface p-3 rounded-lg shadow-md flex-shrink-0 space-y-3 border border-border">
                        <div>
                            ...
                            <div className="w-full bg-bkg rounded p-2 text-sm text-text-primary font-semibold animate-pulse">S/. 25.50</div>
                        </div>
                         <div>
                            <label className="text-xs text-text-secondary">Fecha</label>
                            <div className="w-full bg-bkg rounded p-2 text-sm text-text-primary animate-pulse">2024-08-15</div>
                        </div>
                         <div>
                            <label className="text-xs text-text-secondary">Descripción</label>
                            <div className="w-full bg-bkg rounded p-2 text-sm text-text-primary animate-pulse">Café del día</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        visual: (
             <div className="bg-surface rounded-xl p-6 border border-border w-full h-full flex items-center justify-center">
                <div className="w-full max-w-sm space-y-3">
                    <div className="flex items-center bg-bkg p-3 rounded-lg animate-pulse border border-border" style={{animationDelay: '100ms'}}>
                        <div className="w-8 h-8 rounded-lg bg-red-500/20 mr-3"></div>
                        <div className="flex-grow h-4 bg-border rounded"></div>
                        <div className="w-16 h-4 bg-border rounded ml-4"></div>
                    </div>
                    <div className="flex items-center bg-bkg p-3 rounded-lg animate-pulse border border-border" style={{animationDelay: '200ms'}}>
                        <div className="w-8 h-8 rounded-lg bg-blue-500/20 mr-3"></div>
                        <div className="flex-grow h-4 bg-border rounded"></div>
                        <div className="w-12 h-4 bg-border rounded ml-4"></div>
                    </div>
                    <div className="flex items-center bg-bkg p-3 rounded-lg animate-pulse border border-border" style={{animationDelay: '300ms'}}>
                        <div className="w-8 h-8 rounded-lg bg-green-500/20 mr-3"></div>
                        <div className="flex-grow h-4 bg-border rounded"></div>
                        <div className="w-20 h-4 bg-border rounded ml-4"></div>
                    </div>
                     <div className="flex items-center bg-bkg p-3 rounded-lg animate-pulse border border-border" style={{animationDelay: '400ms'}}>
                        <div className="w-8 h-8 rounded-lg bg-yellow-500/20 mr-3"></div>
                        <div className="flex-grow h-4 bg-border rounded"></div>
        ...
        visual: (
             <div className="bg-surface rounded-xl p-6 border border-border w-full h-full">
                ...
                <div className="mt-4 h-56 w-full flex items-end justify-around space-x-2">
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '100ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg" style={{height: '50%'}}></div></div>
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '200ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg" style={{height: '75%'}}></div></div>
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '300ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg shadow-lg shadow-secondary/50" style={{height: '90%'}}></div></div>
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '400ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg" style={{height: '60%'}}></div></div>
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '500ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg" style={{height: '80%'}}></div></div>
                    <div className="h-full w-full bg-bkg rounded-t-lg animate-pulse relative" style={{animationDelay: '600ms'}}><div className="absolute bottom-0 h-full w-full bg-secondary rounded-t-lg" style={{height: '40%'}}></div></div>
                </div>
             </div>
        )
    }
...
const FeatureSection: React.FC = () => (
    <section id="features" className="py-24 bg-bkg">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedComponent className="max-w-3xl mx-auto text-center">
                <h2 className="text-sm font-bold uppercase tracking-wider text-secondary">CARACTERÍSTICAS PRINCIPALES</h2>
                    ...
                    <AnimatedComponent key={feature.title} delay={200 * (index + 1)}>
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                           <div className={index % 2 !== 0 ? 'md:order-last' : ''}>
                                <div className="p-3 bg-secondary/10 text-secondary inline-block rounded-full text-sm font-bold mb-3">{feature.tag}</div>
...
const PricingSection: React.FC<{ onNavigateToCheckout: (plan: Plan) => void; }> = ({ onNavigateToCheckout }) => (
    <section id="precios" className="bg-bkg py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedComponent className="text-center mb-12">
                <div className="inline-flex items-center justify-center space-x-2 mb-4">
                    ...
                    <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                            <svg key={i} className="h-5 w-5 text-green-400" fill="currentColor" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" /></svg>
                        ))}
                    </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {pricingPlans.map((plan, index) => (
                   <AnimatedComponent key={plan.name} delay={200 * (index + 1)}>
                     <div className={`relative bg-surface rounded-2xl p-8 flex flex-col h-full border-2 transition-transform duration-300 hover:-translate-y-2 ${plan.recommended ? 'border-secondary animate-subtle-glow' : 'border-border'}`}>
                        {plan.recommended && (
                            <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2">
                                <span className="bg-secondary text-white text-xs font-bold uppercase tracking-wider rounded-full px-4 py-1">
                                    Más Vendido
                                </span>
                            </div>
                        )}
                        ...
                        <button 
                            ...
                            className={`mt-8 py-3 rounded-lg font-bold text-lg transition-colors ${plan.recommended ? 'bg-secondary text-white hover:bg-green-600' : 'bg-gray-100 text-text-primary hover:bg-gray-200'}`}>
                            Elegir plan
                        </button>
                        ...
                        <ul className="space-y-4 text-text-secondary flex-grow">
                            {plan.features.map((feature, i) => (
                                <li key={i} className="flex items-start">
                                    <svg className="h-5 w-5 text-secondary mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                ...
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-4 text-text-secondary">
                    {allPlansFeatures.map((feature, i) => (
                        <div key={i} className="flex items-center">
                           <svg className="h-5 w-5 text-green-400 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                            <span className="text-text-primary">{feature}</span>
                        </div>
                    ))}
                </div>
...
const CTASection: React.FC<{ onNavigateToSignUp: () => void; }> = ({ onNavigateToSignUp }) => (
    <section id="cta" className="py-20 bg-bkg border-y border-border">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedComponent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-4 md:space-y-0">
                <p className="text-text-secondary">&copy; {new Date().getFullYear()} FinTrack. Todos los derechos reservados.</p>
                 <div className="text-2xl font-bold text-text-primary">FinTrack</div>
            </div>
        </div>
    </footer>
);
...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToSignIn, onNavigateToSignUp, onNavigateToCheckout }) => {
    return (
        <div className="bg-bkg font-sans">
